...
<body>
    ...
    <div class="w-full p-4">
        <div>
            <h1 class="text-3xl font-bold">Update Book</h1>
        </div>
        <!-- enctype berfungsi agar string dikelola oleh post dan file dikelola$file -->
        <form class="md:w-1/2 w-full p-4 mt-4 bg-blue-200 rounded rounded-lg" method="POST"
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="category_id"
                    class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Category id
                </label>
            </div>
            <div class="relative z-0 w-full mb-5 group">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="author"
                    class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">author
                </label>
            </div>
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="nidn"
                    class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">nidn
                </label>
            </div>
            <div class="relative z-0 w-full mb-5 group">
                <img src="<?php echo $row['photo'] ?>" alt="" width="200" height="200">
                <input type="" name="photo" id="photo"
                    class="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    >
                <label for="photo"
